...
export function TaxBreakdownTable({ brackets, totalTax, fmt }: TaxBreakdownTableProps) {
    const { t } = useLanguage();
        ...
        <Card elevation={0} sx={{ border: 1, borderColor: "divider", borderRadius: 3 }}>
            <CardContent>
                ...
                <Table size="small">
                    <TableHead>
                        <TableRow>
                            <TableCell sx={{ fontWeight: 600 }}>{t("taxBracketRange")}</TableCell>
                            <TableCell sx={{ fontWeight: 600 }} align="right">{t("taxBracketRate")}</TableCell>
                            <TableCell sx={{ fontWeight: 600 }} align="right">{t("taxBracketTax")}</TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                        {brackets.map((b) => (
                            ...
                            >
                                ...
                                <TableCell align="right" sx={{ fontWeight: b.tax > 0 ? 600 : 400 }}>
                                    {fmt(b.tax)}
                                </TableCell>
                            </TableRow>
                        ))}
