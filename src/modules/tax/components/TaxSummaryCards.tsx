...
function SummaryCard({
  ...
  return (
    <Card
      elevation={0}
      sx={{ border: 1, borderColor: "divider", borderRadius: 3, flex: 1 }}
    >
      <CardContent>
  ...
  return (
    <Stack spacing={2}>
      <Stack direction={{ xs: "column", sm: "row" }} spacing={2}>
        ...
        <SummaryCard
          label={t("taxTotalDeductions")}
          value={fmt(totalDeductions)}
          color="success.main"
        />
        <SummaryCard
          label={t("taxNetIncome")}
          value={fmt(netIncome)}
          color="info.main"
        />
      </Stack>
        ...
        <Box sx={{ p: 3 }}>
          ...
          >
            <Box>
              ...
              <Typography
                variant="body2"
                sx={{ color: "error.dark", opacity: 0.75, mt: 0.5 }}
              >
                {t("taxYear2569")}
              </Typography>
            </Box>
            ...
            >
              <Typography
                variant="caption"
                sx={{ color: "error.dark", opacity: 0.8 }}
              >
                {t("taxEffectiveRate")}
              </Typography>
              <Typography
