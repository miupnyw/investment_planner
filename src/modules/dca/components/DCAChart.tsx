...
export function DCAChart({ data, currentYear, retireYear, coastStartYear, coastYears, fmt }: DCAChartProps) {
    const { t } = useLanguage();
        ...
        <Card elevation={0} sx={{ border: 1, borderColor: "divider", borderRadius: 3 }}>
            <CardContent>
                ...
                <ResponsiveContainer width="100%" height={360}>
                    <LineChart data={data} margin={{ top: 4, right: 24, left: 16, bottom: 4 }}>
